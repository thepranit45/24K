...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,.sevalla.app,.onrender.com,*', cast=Csv())
CSRF_TRUSTED_ORIGINS = config(
    'CSRF_TRUSTED_ORIGINS',
    default='http://localhost:8000,http://127.0.0.1:8000,https://*.sevalla.app,https://*.onrender.com',
    cast=Csv()
)
...
# Email
# ──────────────────────────────────────────────
# Real SMTP kicks in once EMAIL_HOST_USER + EMAIL_HOST_PASSWORD are set in .env
# (e.g. Gmail app password). Without them, mail is printed to the server console
# so flows keep working during development.
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER or 'noreply@24k.in')
